      ...
      <div className="flex flex-col sm:flex-row space-x-0 sm:space-x-8 space-y-8 sm:space-y-0 text-black w-full sm:w-[1200px] mx-auto">
        <div className="flex flex-col space-y-8 w-full sm:w-1/2">
          <p>
            ...
            personal y detallado. Entendemos la complejidad de los asuntos
            civiles y estamos comprometidos a proteger tus derechos e intereses
            en cada paso del proceso. Desde disputas contractuales hasta asuntos
            de propiedad, nuestra meta es brindarte soluciones claras y
            efectivas.
          </p>
