        ...
        <div className="relative text-black w-full sm:w-2/3 flex flex-col space-y-6 justify-center px-4 sm:px-8 pt-4 pb-14 sm:py-16">
          ...
          <div className="text-sm">
            <p>
              ...
              desafíos legales con un equipo experto y experimentado. Como
              firma, nos dedicamos a proporcionar soluciones legales integrales
              y personalizadas, asegurando un acompañamiento cercano y efectivo
            ...
            <p>
              ...
              económica si alcanzamos los objetivos planteados, asegurando así
              que nuestros intereses estén plenamente alineados con los de
              nuestros clientes.
            </p>
          </div>
        </div>
