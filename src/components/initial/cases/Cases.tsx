...
const Cases = () => {
  ...
  return (
    <div className="bg-primary py-14 w-full flex flex-col relative">
      ...
      <div className="w-full sm:w-[1200px] px-4 sm:mx-auto flex flex-col text-center sm:text-center">
        ...
        <div className="flex flex-col sm:flex-row mb-14 justify-center self-center w-full">
      ...
      <div className="absolute bottom-0 right-8 z-20">
        <Image src="/images/circle1.png" alt="Logo" width={200} height={100} />
      </div>
    </div>
  );
};
